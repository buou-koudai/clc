...
# 使用方法: curl -s https://raw.githubusercontent.com/buou-koudai/cursor-lazy-cat/main/update-cursor-plugin.ps1 | powershell -

# 配置参数
$GithubRepo = "buou-koudai/cursor-lazy-cat" # GitHub用户名和仓库名
